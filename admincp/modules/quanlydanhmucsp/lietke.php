    ...
    <table>
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="modules/quanlydanhmucsp/xuly.php?query=xoa&iddanhmuc=<?php echo $row["id_danhmuc"]?>">Xóa</a> | <a href="?action=quanlydanhmucsanpham&query=sua&iddanhmuc=<?php echo $row["id_danhmuc"]?>">Sửa</a>
          </td>
        </tr>
      <?php 
           }
