    ...
    <table>
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="modules/quanlysp/xuly.php?query=xoa&idsanpham=<?php echo $row["id_sanpham"] ?>">Xóa</a>|<a href="?action=quanlysanpham&query=sua&idsanpham=<?php echo $row["id_sanpham"] ?>">Sửa</a>
          </td>
        </tr>
      <?php 
           }
